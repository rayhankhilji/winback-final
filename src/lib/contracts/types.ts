...
export type RunStage = z.infer<typeof S.RunStageSchema>;
export type DocumentStatus = z.infer<typeof S.DocumentStatusSchema>;
export type DocumentProgress = z.infer<typeof S.DocumentProgressSchema>;
export type RunProgress = z.infer<typeof S.RunProgressSchema>;
export type CompanyStatus = z.infer<typeof S.CompanyStatusSchema>;
export type CompanyListItem = z.infer<typeof S.CompanyListItemSchema>;
export type DocumentMeta = z.infer<typeof S.DocumentMetaSchema>;
export type BlockViewerResponseData = z.infer<typeof S.BlockViewerResponseDataSchema>;
export type CompanyDetailResponseData = z.infer<typeof S.CompanyDetailResponseDataSchema>;
export type IngestRequest = z.infer<typeof S.IngestRequestSchema>;
